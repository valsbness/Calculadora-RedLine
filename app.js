...
// Precios de la página de Benny's. Nitro y Botella de Nitro son extras añadidos
// porque no aparecen en esa página; déjalos en 0 hasta colocar el precio oficial.
const PACKAGES = [
  {name:'FULL TUNING V8',price:110000,detail:'Todo junto: Motor V8 + Turbo Charger + Frenos Cerámicos + Llantas Slick + Tracción AWD'},
  {name:'FULL TUNING V12',price:570000,detail:'Referencia calculada: Motor V12 + Turbo Charger + Frenos Cerámicos + Llantas Slick + Tracción AWD'}
];
